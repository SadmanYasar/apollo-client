...
This is useful when using the same query and variables combination in more than one component, otherwise the components may clobber each other. This option can also be used to force the query to re-evaluate fresh.
